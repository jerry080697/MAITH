...
export default function Home() {
  return (
    <div className="flex mx-auto max-w-screen-xl h-screen gap-4 justify-center items-center py-12">
      ...
      <div className="grid grid-cols-3 w-full gap-4 justify-stretch content-stretch h-full">
        <Link className="relative bg-zinc-900 text-white flex items-center justify-center h-full transition hover:scale-105" href="/questions/create">
          <p className="text-4xl font-bold">문제 생성</p>
          <div className="absolute top-0 right-0 p-4">
            <i className="fas fa-circle-plus text-5xl"></i>
          </div>
        </Link>
        <div className="relative bg-violet-600 text-white flex items-center justify-center h-full">
        ...
        <div className="relative bg-zinc-900 text-white flex items-center justify-center h-full">
          <div className="absolute bottom-0 left-0 w-full h-full bg-zinc-300/40 p-4">
            <p className="text-2xl font-bold text-red-300">Under construction</p>
            <p className="text-lg">아직 준비 중인 기능입니다.</p>
          </div>
        ...
        <div className="relative bg-yellow-300 text-black flex items-center justify-center h-full">
          <div className="absolute bottom-0 left-0 w-full h-full bg-zinc-300/40 p-4">
